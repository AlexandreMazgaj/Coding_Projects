...
;;Functions to deal with the questions database
;;---------------------------------------------
...
;;Selects which question should be asked
;;--------------------------------------
...
;;Get the question that could help the inference engine to converge to the answer faster
;;--------------------------------------------------------------------------------------
...
;;Sees if facts in the facts database are in the goals
;;----------------------------------------------------
...
;;Updates the facts database
;;-------------------------
(defun ChangerBaseFait (conclu)
  (if (not (equal conclu nil))
    (if (and (listp conclu) (assoc (car conclu) *baseFait*))       
...
;;Get the answer from the user and transforms it into a 'T or a 'NIL
;;------------------------------------------------------------------
...
;;Tells which rules can be used and returns them inside a list
;;------------------------------------------------------------
(defun regleCand (etat baseregle) (let ((lbis) (verif))                                 
...
;;Little animation with our logo
;;------------------------------
(defun logo ()
